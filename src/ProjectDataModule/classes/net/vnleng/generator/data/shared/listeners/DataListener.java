 ...
 */
package net.vnleng.generator.data.shared.listeners;
 ...
 * @author gabri
 */
public interface DataListener extends CallbackEventHandler<ResourceInstance> {

    public static enum DataEventType {
        INSTANTIATED, CREATED, REMOVED
    }
